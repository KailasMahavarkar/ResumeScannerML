...
#         if model_result[i] > 0:
#             context.append({"value": "{:.3f}".format(
#                 model_result[i]*100), "name": category[i]})
...
#     else:
#         print("Relative Document does not seem to be of any IT person")


# if __name__ == '__main__':
#     print("Resume Analyzer, ML model based on NLTK")
#     mode = env.MODE
#     empty = st.empty()
...
#         text_area_data = st.text_area(
#             "Enter Your Company Requirements", height=200)
...
#             ranked_data = Rank.RankResume(
#                 loaded_model=env.MODEL, text=text_area_data)
